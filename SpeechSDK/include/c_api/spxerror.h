...
/// </summary>
#define SPXERR_VISION_SITE_FAILURE __SPX_ERRCODE_FAILED(0x050)

/// <summary>
/// Stream number provided was incorrect.
/// Added in version 1.15.0.
/// </summary>
#define SPXERR_MEDIA_WRONG_STREAM __SPX_ERRCODE_FAILED(0x060)

/// <summary>
/// Offset required is invalid in the current context.
/// Added in version 1.15.0.
/// </summary>
#define SPXERR_MEDIA_INVALID_OFFSET __SPX_ERRCODE_FAILED(0x061)

/// <summary>
/// No more data is available in source.
/// Added in version 1.15.0.
/// </summary>
#define SPXERR_MEDIA_NO_MORE_DATA __SPX_ERRCODE_FAILED(0x062)

/// <summary>
/// Source has not been started.
/// Added in version 1.15.0.
/// </summary>
#define SPXERR_MEDIA_NOT_STARTED __SPX_ERRCODE_FAILED(0x063)

/// <summary>
/// Source has already been started.
/// Added in version 1.15.0.
/// </summary>
#define SPXERR_MEDIA_ALREADY_STARTED __SPX_ERRCODE_FAILED(0x064)
